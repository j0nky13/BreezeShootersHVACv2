...
export default function ServicePreview() {
  ...
  return (
    <section
      id="services"
      className="relative scroll-mt-28 py-24 px-6 overflow-x-hidden"
      data-aos="fade-up"
      data-aos-duration="800"
    >
      {/* top gradient blend from blue into white */}
      <div className="pointer-events-none absolute inset-x-0 top-0 z-0 h-56 bg-[linear-gradient(180deg,rgba(8,175,255,1)_0%,rgba(8,175,255,.65)_35%,rgba(8,175,255,.2)_60%,rgba(255,255,255,1)_100%)]" />
      ...
      {/* bottom subtle blue tail */}
      <div className="pointer-events-none absolute inset-x-0 bottom-0 z-0 h-10 bg-[linear-gradient(180deg,rgba(255,255,255,0)_0%,rgba(8,175,255,.25)_100%)]" />
    </section>
  )
}